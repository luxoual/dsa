...
Started with the base cases and defining the starting points for the tabulation. Took a little bit of thinking for the conditionals, just to avoid and fully account for edge cases. For the space optimized solution, I had to really think about the repeated state that the algorithm was working through and what actual space was needed at each entry into that state was.